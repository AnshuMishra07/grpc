...
public final class EmployeeServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.learning.EmployeeService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.learning.Employee,
      com.learning.EmployeeRespnse> getGetEmployeeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployee",
      requestType = com.learning.Employee.class,
      responseType = com.learning.EmployeeRespnse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.learning.Employee,
      com.learning.EmployeeRespnse> getGetEmployeeMethod() {
    io.grpc.MethodDescriptor<com.learning.Employee, com.learning.EmployeeRespnse> getGetEmployeeMethod;
      ...
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeMethod = EmployeeServiceGrpc.getGetEmployeeMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeMethod = getGetEmployeeMethod = 
              io.grpc.MethodDescriptor.<com.learning.Employee, com.learning.EmployeeRespnse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.learning.EmployeeService", "getEmployee"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.learning.Employee.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.learning.EmployeeRespnse.getDefaultInstance()))
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployee(com.learning.Employee request,
        io.grpc.stub.StreamObserver<com.learning.EmployeeRespnse> responseObserver) {
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public com.learning.EmployeeRespnse getEmployee(com.learning.Employee request) {
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.learning.EmployeeRespnse> getEmployee(
        com.learning.Employee request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE:
          serviceImpl.getEmployee((com.learning.Employee) request,
              (io.grpc.stub.StreamObserver<com.learning.EmployeeRespnse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EmployeeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.learning.EmployeeOuterClass.getDescriptor();
    }
